...
**Short answer: yes, legal and ordinary - it's the same regulatory basis as your Wi-Fi router.** (Regulatory research, not legal advice; US-scoped - EU 868 MHz adds duty-cycle limits.)

- **Encryption on license-free ISM bands is permitted.** Meshtastic operates at 902–928 MHz under [47 CFR § 15.247](https://www.ecfr.gov/current/title-47/chapter-I/subchapter-A/part-15/subpart-C/subject-group-ECFR2f2e5828339709e/section-15.247) - the same rule section as Wi-Fi and Bluetooth. Part 15 limits power/bandwidth/emissions and says nothing against encrypting content. Meshtastic's default AES-256-CTR (+ X25519 for DMs) is fully compliant, no license required. Constraints that do matter: 1 W conducted power cap (stock hardware is far under), and use FCC-certified radio modules operated within their grants - which commercial Meshtastic boards are. No duty-cycle limit in the US 915 MHz band.
...
**FAQ one-liner:** *"Dynamically creating encrypted mesh networks on license-free bands is as legal as running a password-protected Wi-Fi network - it's the same FCC rule section. Restrictions on encryption apply to amateur-radio bands, which NephMesh doesn't use unless you opt in."*
